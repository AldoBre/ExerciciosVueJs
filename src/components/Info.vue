<template>
    <div>
        <p v-if="esta_trabalhando">Estou trabakhando no momento.</p>
        ...
        <p>PAra acessar meu portifólio <a v-bind:href="meu_link">Clique aqui</a></p>
        <Picture />
    </div>
</template>
...
export default{
    ...
    data(){
        return{
            ...
            textoBotao: 'Texto Assim',
            backend_technologies:['JAvasript','php','python'],
